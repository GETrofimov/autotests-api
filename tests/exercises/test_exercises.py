...
from tools.assertions.exercises import assert_create_exercise_response, assert_exercise_not_found, assert_get_exercise_response, assert_get_exercises_response, assert_update_exercise_response
...
class TestExercises:
    ...
    def test_delete_exercise(self, exercise_client: ExercisesClient, function_exercise: ExerciseFixture):
        ...
        get_exercise_response = exercise_client.get_exercise_api(function_exercise.response.exercise.id)
        ...
        assert_exercise_not_found(get_exercise_response_data)
    ...
    @allure.title("Get multiple exercises")
    @allure.severity(Severity.BLOCKER)
